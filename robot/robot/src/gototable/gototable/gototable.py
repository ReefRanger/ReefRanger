...
class GoTableServer(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('threshold_x', 1.0)
        self.declare_parameter('threshold_y', 1.0)
        ...
        self.get_logger().info(f'PID Gains for X: kp={self.kp_x}, ki={self.ki_x}, kd={self.kd_x}')
        self.get_logger().info(f'PID Gains for Y: kp={self.kp_y}, ki={self.ki_y}, kd={self.kd_y}')
    ...
    def execute_callback(self, goal_handle):
        ...
        while rclpy.ok():
            ...
            self.get_logger().info(f'PID Output -> Force: X={force.x}, Y={force.y}, Z={force.z}')
